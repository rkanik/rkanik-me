<template>
	<div class="flex">
		<div
			class=" bg-gray-900 w-20 flex-none flex flex-col min-h-screen h-screen px-2 py-2"
		>
		...
		<div class="flex-1 flex flex-col min-h-screen h-screen">
			<div class="flex text-white h-12">
				...
				<div
					class="flex-1 bg-gray-600 flex items-center justify-between border-b border-gray-900 px-4"
				>
			...
			<div class="flex-1 flex overflow-y-hidden">
				<div class="bg-gray-800 w-56 flex-none flex flex-col justify-between">
					<div class="hashtag-bar text-sm leading-relaxed overflow-y-auto">
						...
						<ul class="px-2 py-3 pt-2">
							<li
								class="text-gray-200 px-2 hover:text-gray-200 hover:bg-gray-900 bg-gray-600 rounded"
							>
								<a href="#" class="flex items-center">
									<span class="text-xl">#</span>
							...
							<a href="#"
								><img
									...
									class="w-8 h-8 rounded-full"
												@error.once="
													$event.target.src = 'https://via.placeholder.com/32'
												"
							/></a>
				...
				<div class="flex-1 flex justify-between">
					<div class="bg-gray-600 flex-1 flex flex-col justify-between">
						...
						<div
							class="bg-gray-600 h-24 flex items-center mx-3 border-t border-gray-600"
						>
							<button
							...
							<div
								class="px-2 py-2 bg-gray-700 rounded-r flex items-center h-10"
							>
								<button
									class="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white"
								>
									<svg
										class="w-6 h-6"
										fill="currentColor"
								...
								<button
									class="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white ml-3"
								>
									<svg
										class="w-8 h-8"
										fill="currentColor"
										...
										viewBox="0 0 24 24"
									>
										<defs><path id="a" d="M24 24H0V0h24v24z"></path></defs>
										<clipPath id="b">
					...
					>
						...
						<ul class="mb-6 truncate">
							<li
								class="text-gray-500 px-2 hover:text-gray-200 hover:bg-gray-600 py-1 my-2"
							>
								<a href="#" class="flex items-center">
